...
const labels: Record<Department, string> = {
  finance: "Finance", lab: "Lab", sports: "Sports", classroom: "Classroom", dorm: "Dormitory",
    ...
    <Card className="border-blue-200 bg-blue-50/30">
      ...
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <Button type="submit" disabled={mutation.isPending}>{mutation.isPending ? <><Spinner className="mr-2 h-4 w-4" />Saving…</> : record ? "Save changes" : "Add information"}</Button>
        </form>
      </CardContent>
    </Card>
  );
