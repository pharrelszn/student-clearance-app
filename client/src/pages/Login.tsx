    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <Card className="border-border glassmorphism">
          <CardHeader>
            <CardTitle className="flex items-center gap-2"><Shield className="w-5 h-5" />Department Access</CardTitle>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleLogin} className="space-y-4">
              <div>
                <label className="text-sm font-medium">Department Passcode *</label>
                <Input type="password" value={passcode} onChange={(e) => setPasscode(e.target.value)} placeholder="Enter your department passcode" className="mt-2 border-border" disabled={isLoading} autoFocus />
              </div>
              <Button type="submit" className="w-full bg-black hover:bg-gray-800 text-white transition-smooth" disabled={isLoading}>
              ...
              <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg space-y-2">
                ...
                <div className="text-xs text-blue-800 space-y-1">
                  <p>• Super Admin</p><p>• Finance</p><p>• Library</p><p>• Lab/ICT</p><p>• Sports</p><p>• Dorm/Hostel</p><p>• Medical</p><p>• Registrar</p><p>• Classroom</p>
                </div>
              </div>
